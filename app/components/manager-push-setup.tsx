    ...
    async function init() {
      ...
      if (ios && !standalone) {
        if (!cancelled) {
          ...
          setMessage(
            "On iPhone/iPad: tap Share → Add to Home Screen, open Hercules 1612 from the home screen icon, then return here and enable notifications.",
          );
        }
        return;
      }
    ...
    <div className="grid gap-4">
      ...
      {status === "needs-install" ? (
        <ol className="list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
          ...
          <li>Open Hercules 1612 from the new home screen icon.</li>
